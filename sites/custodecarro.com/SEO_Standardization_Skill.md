...
1. Atualize o campo `<lastmod>` no `sitemap.xml` para a data atual.
2. Reenvie o sitemap no painel do GSC.
3. Clique em **"Validar Correção"** no relatório de Erros de Redirecionamento.
